package org.integratedmodelling.thinklab.client.configuration;
...
import org.integratedmodelling.thinklab.client.ServerConfiguration;
...
public class Configuration implements IConfiguration {
	...
	public void persistProperties() throws ThinklabClientException {
		File td = 
				new File(getWorkspace(SUBSPACE_CONFIG) + File.separator + "thinklab.properties");
	 ...
	 * @return
	 */
	public Collection<ServerConfiguration> getRemotes() {
