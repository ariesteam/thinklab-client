...
public class CopyURL {
	 ...
	 */
	public static long copy(URL url, File file) throws ThinklabClientException
	{
		long count=0;
	 ...
	 * @throws ThinklabIOException if URL can't be read or file can't be written.
	 */
	public static long copy(File url, File file) throws ThinklabClientException
	{
		long count=0;
    ...
    public static void copyBuffered(File src, File dst) throws ThinklabClientException {
    ...
    public static File getFileForURL(URL url) throws ThinklabClientException {
    ...
    public static void copyChanneled(File src, File dst) throws ThinklabClientException {
